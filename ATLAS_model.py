...
# =============================================================================
"""
This script allows to replicate the results presented in the manuscript 'More than one million barriers fragment Europe’s rivers' by Belletti et al. 
It takes as input *.csv file with barrier drivers information for different aggregation of sub-basins and predict barrier density and barrier numbers at pan-european-scale.

Script authors: Simone Bizzi and Barbara Belletti
Contact: simone.bizzi@unipd.it

License: Creative Commons by Attribution.
This script can be used for commercial and non-commercial purposes provided the author is acknowledged.
If used in student work, it should be added as a text file in the appendice of the work.
